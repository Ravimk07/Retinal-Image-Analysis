...
import Augmentor
# Z:\Ravi K\Other\ISBI_2019_challenge\iChallenge_AMD\Task_3\New_data\exudates\new_augmented\train\label
...
# image_dir = Path("Z:/Ravi K/Other/ISBI_2019_challenge/iChallenge_AMD/Task_3/New_data/exudates/new_augmented/val/label/")
# label_dir = Path("Z:/Ravi K/Other/ISBI_2019_challenge/iChallenge_AMD/Task_3/New_data/exudates/new_augmented/val/label/")

image_dir = Path("Z:/Ravi K/Other/ISBI_2019_challenge/iChallenge_AMD/Task_3/New_data/hemorrhage/new_augmented/val/label/")
label_dir = Path("Z:/Ravi K/Other/ISBI_2019_challenge/iChallenge_AMD/Task_3/New_data/hemorrhage/new_augmented/val/label/")
...
#                 label = cv2.imread(str(label_file))
                ...
                img = cv2.imread(str(image_file),0)       # for label
#                 label = cv2.imread(str(label_file))
